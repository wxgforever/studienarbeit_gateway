...
client = n.serviceClient<studienarbeit_gateway::test2Method>("service2");
studienarbeit_gateway::test2Method srv;

trans_bank.trans_string=*(UA_String*)input[0].data;
srv.request.function=(char*)trans_bank.trans_string.data;

trans_bank.trans_int64=*(UA_Int64*)input[1].data;
srv.request.group=trans_bank.trans_int64;

trans_bank.trans_double=*(UA_Double*)input[2].data;
srv.request.x=trans_bank.trans_double;

trans_bank.trans_double=*(UA_Double*)input[3].data;
srv.request.y=trans_bank.trans_double;

trans_bank.trans_double=*(UA_Double*)input[4].data;
srv.request.z=trans_bank.trans_double;
...
trans_bank.trans_string=UA_STRING((char*)srv.response.describe.c_str());
UA_Variant_setScalarCopy(&output[0], &trans_bank.trans_string, &UA_TYPES[UA_TYPES_STRING]);

trans_bank.trans_double=srv.response.result;
UA_Variant_setScalarCopy(&output[1], &trans_bank.trans_double, &UA_TYPES[UA_TYPES_DOUBLE]);
